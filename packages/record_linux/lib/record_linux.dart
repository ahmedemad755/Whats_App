...
class RecordLinux extends RecordPlatform {
  ...
  // Patched: added {bool request = true} to match record_platform_interface >= 1.5.0
  @override
  ...
  Future<void> start(
    ...
    if (!supported) throw Exception('${config.encoder} is not supported.');
  ...
  // Patched: added startStream to satisfy record_platform_interface >= 1.0.0
  // Not functional on Linux in this patched version, but required to compile.
  @override
  ...
  List<String> _getAacQuality(int bitRate) {
    final quality = (bitRate ~/ 1000).clamp(8, 800).toInt();
